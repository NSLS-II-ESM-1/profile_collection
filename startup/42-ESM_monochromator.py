...
#        self.Grt_Offset['A']={'1200': '81.96057028',
#                              '800': '81.94253989', 
#                              '600': '81.91078284999999',
#                              '300': '81.88872792'}
...
#        self.M2_Offset['A']={'1200': '83.77423664999999',
#                             '800': '83.76199202',
#                             '600': '83.75227599',
#                             '300': '83.75307140000001'}
#        self.M2_Offset['B']={'1200': '83.773809',
#                             '800': '83.7609090000',
#                             '600': '83.776709',
#                             '300': '83.7605'}

#        self.c_value['A']={'1200': 2.025,
#                           '800': 3.1,
#                           '600': 2.9,
#                           '300': 1.975}
...
#                                                      162.841, 189.785, 299.25, 427.514, 538, 608, 635 ],
#                                     'Gap': [16, 17.5, 19, 21, 23, 25, 27, 29, 31, 33, 36, 38, 40, 42,
#                                             44, 48, 51, 54, 57, 60, 70, 80, 90, 100, 120]}
...
#                                                70.3, 71.9, 73.5, 75.1, 76.7, 78.2, 80, 90, 100, 120, 140] }
#        self.Und_Energy_LV['EPU105'] = {'Energy':  [ 50.,   60.,   70.,   80.,   90.,  100., 120.,  140.,  160.,  180.,  200.,  220.,  240.,  260.,  280.,  300.,  350.,
#                                                     400.,  450.,  500.,  550.],
#                                     'Gap' :  [ 24.100100000000001, 26.1005, 27.6997, 29.200000000000003, 30.600000000000001, 31.800000000000001, 33.997700000000002, 36.0, 37.700200000000002,
#                                                39.300000000000004, 40.8001, 42.1999, 43.600000000000001, 44.899900000000002, 46.097500000000004, 47.300000000000004, 50.300000000000004,
#                                                53.200000000000003, 56.200000000000003, 59.300000000000004, 62.600000000000001]}
 ...
 #                                  'ang' :  [-0.71500000000000008, -0.71360000000000001, -0.71310000000000007, -0.7128000000000001,
 #                                              -0.71250000000000002, -0.71230000000000004, -0.71210000000000007, -0.71210000000000007,
 #                                              -0.71200000000000008, -0.7118000000000001, -0.71170000000000011, -0.71160000000000001,
 #                                              -0.71150000000000002, -0.71140000000000003, -0.71140000000000003, -0.71130000000000004,
 #                                              -0.71130000000000004, -0.71120000000000005, -0.71120000000000005] }
